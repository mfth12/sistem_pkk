            ...
            <div class="row mb-4">
              <div class="col">
                <div class="input-group">
                  ...
                  <input type="text" value="<?php if ($userb->akses_level == 'superadmin') echo "Admin PKK"; ?><?php if ($userb->akses_level == 'sekret_pokja') echo "Sekretaris Pokja"; ?><?php if ($userb->akses_level == 'kades') echo "Kepala Desa"; ?>
