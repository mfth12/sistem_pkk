                    ...
                    <div class="d-flex justify-content-between lh-condensed">
                        <div class="d-flex">
                            <p><a href="<?php echo site_url('admin') ?>" class="btn btn-danger" data-toggle="modal" data-target="#tambahKeluaran">
                                    <i class="fa fa-plus"></i> Tambah Surat Keluar</a></p>
                        </div>
                        <div>
                                ...
                                foreach ($result as $data) { ?>
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="<?php echo site_url('admin/surat/ubah_keluar/' . $data->id_surat) ?>" class="btn btn-sm btn-light mr-1"><i class="fa fa-edit"></i></a>
                                            <a onclick="deleteConfirm('<?php echo site_url('admin/surat/hapus_out/' . $data->id_surat) ?>')" href="#!" class="btn btn-light btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                } ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo site_url('admin/surat/keluar') ?>" method="post" enctype="multipart/form-data">
