                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                            <?php $no=1; foreach($struktur as $data) { ?>
                                <tr>
                                    <td class="text-center"><h4><?php echo $data->nomor ?></h4></td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a onclick="deleteConfirm('<?php echo site_url('superadmin/struktur/delete/'.$data->slider_id) ?>')"
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo site_url('superadmin/struktur/add') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            required type="text" name="name" placeholder="Nama Lengkap" />
						                </div>

                                        <div class="form-group">
							                <label for="name">Urutan Tampil *</label>
							                <input class="form-control"
                                            required type="number" name="nomor" value="<?php echo $nomor?>" placeholder="<?php echo $nomor?>"/>
						                </div>

						                <div class="form-group">
						                	<label for="deskription">Jabatan Pengurus *</label>
						                	<textarea class="form-control"
						                	 name="description" required placeholder="Keterangan Jabatan Pengurus"></textarea>
