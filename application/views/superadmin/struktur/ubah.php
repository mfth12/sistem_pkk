            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
					...
					<input class="form-group"
                           required type="hidden" name="id" value="<?php echo $struktur->slider_id?>" />
					...
					<input class="form-control-file"
					   	  required type="hidden" name="image" />
				    ...
				    <input class="form-control"
                          required type="text" name="name" value="<?php echo $struktur->name ?>"/>
				    </div>

					<div class="form-group">
					    <label for="name">Urutan Tampil *</label>
					    <input class="form-control"
                        required type="number" name="nomor" value="<?php echo $struktur->nomor?>" placeholder="<?php echo $struktur->nomor?>"/>
					</div>
					
				    <div class="form-group">
				   	<label for="deskription">Keterangan Slide *</label>
				   	<textarea class="form-control"
				   	 name="description" required ><?php echo $struktur->description ?></textarea>
