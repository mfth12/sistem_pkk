            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
					...
					<input class="form-group"
                           required type="hidden" name="id" value="<?php echo $slide->slider_id?>" />
				    ...
				    <input class="form-control"
                          required type="text" name="name" value="<?php echo $slide->name ?>"/>
				    </div>

					<div class="form-group">
					    <label for="name">Urutan Tampil *</label>
					    <input class="form-control"
                        required type="number" name="nomor" value="<?php echo $slide->nomor?>" placeholder="<?php echo $slide->nomor?>"/>
					</div>
					
				    <div class="form-group">
				   	<label for="deskription">Keterangan Slide *</label>
				   	<textarea class="form-control"
				   	 name="description" required ><?php echo $slide->description ?></textarea>
