                            ...
                            <?php $no=1; foreach($slider as $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a onclick="deleteConfirm('<?php echo site_url('superadmin/sliders/delete/'.$data->slider_id) ?>')"
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo site_url('superadmin/sliders/add') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            required type="text" name="name" placeholder="Nama judul slide" />
						                </div>
						                ...
						                <div class="form-group">
						                	...
						                	<textarea class="form-control"
						                	 name="description" required placeholder="Keterangan Slide"></textarea>
