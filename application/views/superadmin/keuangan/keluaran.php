                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php $i=1; foreach($result as $data) { ?>
                                <tr>
                                    ...
                                    <td><?php if($data->jenis=="masuk"){ ?><span class="badge badge-pill badge-success">Pemasukan</span> <?php } if($data->jenis=="keluar") { ?><span class="badge badge-pill badge-danger">Pengeluaran</span> <?php }?></td>
                                    ...
                                    <a onclick="deleteConfirm('<?php echo site_url('superadmin/keuangan/hapus_out/'.$data->nomor) ?>')"
