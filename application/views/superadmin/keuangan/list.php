                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php $i=1; foreach($result as $data) { ?>
                                <tr>
                                    ...
                                    <td><?php if($data->jenis=="masuk"){ ?><a href="<?php echo site_url('superadmin/keuangan/masukan') ?>"><span class="badge badge-pill badge-success">Pemasukan</span></a> <?php } if($data->jenis=="keluar") { ?><a href="<?php echo site_url('superadmin/keuangan/keluaran') ?>"><span class="badge badge-pill badge-danger">Pengeluaran</span></a><?php }?></td>
                                    ...
                                    <a onclick="deleteConfirm('<?php echo site_url('superadmin/keuangan/hapus_data/'.$data->nomor) ?>')"
