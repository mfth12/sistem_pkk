...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2021 at 11:27 AM
...
('20210609004', 'asdasdssdsdsd', '2021-06-09', '23', 'keluar');
...
(9324, 1, 'Mubarok', 'GALERI60c7f27504a9a.jpg', 'Mubarok'),
(9325, 25, 'Text', 'GALERI60c7f3e56d0e6.jpg', 'Alt text'),
(9326, 26, 'logo', 'GALERI60c7f42e95cd1.png', 'logoa1');
...
(9327, 17, 'Syah Han', '', 'QUOTE60c82699419ea.png', 'Saya adalah beruang cokelat'),
(9329, 18, 'adsa', '5656', 'QUOTE60c831dec7cc4.png', 'Pengalaman saya ada banyak sekali yang bisasaya baca disini tentang semua hal ya'),
(9330, 2, 'Ramadhan', 'Sekretaris PKK anggota pengganti juga bisa boleh', 'QUOTE60c8317a80197.jpg', 'Saya adalah mahasiswa Saya adalah mahasiswa Saya adalah mahasiswa Saya adalah ma'),
...
(2959, 3, 'Keripik Pisang', 'PENGURUS60c63269cb3db.jpg', 'Anggota Biasa 5');
...
(643, 'sekret pokja', 'sekret@gmail.com', 'sekret', 'desa', 'sekret_pokja'),
(644, '1', '1@ga', '1', '1', 'superadmin'),
(645, '2', '2@fa', '2', '2', 'sekret_pokja'),
(646, '3', '3@fa', '3', '3', 'kades');
...
--
ALTER TABLE `galeri`
  MODIFY `galeri_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9327;
...
--
ALTER TABLE `masukan`
  MODIFY `masukan_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=520;

--
-- AUTO_INCREMENT for table `periode`
--
ALTER TABLE `periode`
  MODIFY `id_periode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3993;
...
--
ALTER TABLE `struktur`
  MODIFY `struktur_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2960;
