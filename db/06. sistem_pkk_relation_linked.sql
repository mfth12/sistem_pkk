...
INSERT INTO `proker` (`id_proker`, `id_proker_utama`, `id_pokja`, `nama_proker`, `keterangan_proker`, `status`, `tanggal_post`) VALUES
(3811, 42712, 81, 'Pelatihan Memasak', 'Pelaksanaan dilakukan 2 bulan sekali', 'OK', '2021-06-19 00:00:00'),
(3812, 42712, 75, 'Seminar Nasional', 'Dilaksanakan satu kali setahun', 'OK', '2021-06-15 00:00:00');
...
INSERT INTO `proker_utama` (`id_proker_utama`, `id_periode`, `nama_proker_utama`) VALUES
(42711, 13851, 'Urusan Tata Usaha'),
(42712, 13851, 'Urusan Rumah Tangga');
...
--
ALTER TABLE `masukan`
  MODIFY `masukan_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=521;
...
--
ALTER TABLE `proker`
  MODIFY `id_proker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3813;

--
-- AUTO_INCREMENT for table `proker_utama`
--
ALTER TABLE `proker_utama`
  MODIFY `id_proker_utama` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42713;
...
ALTER TABLE `proker`
  ...
  ADD CONSTRAINT `proker_ibfk_2` FOREIGN KEY (`id_pokja`) REFERENCES `pokja` (`id_pokja`) ON DELETE SET NULL ON UPDATE CASCADE;
